...
# HSP 90
png("results/SRM/boxplot-HSP90-site-trans-sums.png", width = 400, height = 500)
...
# PDI
png("results/SRM/boxplot-PDI-site-trans-sums.png", width = 400, height = 500)
...
# HSP 90
png("results/SRM/boxplot-HSP90-region.png", width = 400, height = 500)
...
# PDI
png("results/SRM/boxplot-PDI-region.png", width = 400, height = 500)
...
#HSP90
png("results/SRM/scatterbysample-HSP90.png", width = 800, height = 700)
...
#PDI 
png("results/SRM/scatterbysample-PDI.png", width = 800, height = 700)
...
# HSP 90
png("results/SRM/boxplot-HSP90-site.png", width = 400, height = 500)
...
# PDI
png("results/SRM/boxplot-PDI-site.png", width = 400, height = 500)
