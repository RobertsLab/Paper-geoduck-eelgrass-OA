...
DIA.p <- plot_ly(data=as.data.frame(DIA.NMDS.samples), x=~NMDS1, y=~NMDS2, type="scatter", mode="text", text=~DIA4vegan$Sample, hoverinfo=~rownames(DIA.NMDS.samples), color = ~DIA4vegan$Bay) %>%
