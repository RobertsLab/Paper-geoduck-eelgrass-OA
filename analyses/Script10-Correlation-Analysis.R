...
for (i in 1:length(Protein.names.corr)) {
    ...
    dev.off()
   png(paste("results/Correlation-plots/", Protein.names.corr[[i]], "-pH Variance-Corrplot.png", sep=""), width=700, height=500)
    plot(subset(Master.SRM, (Protein==Protein.names.corr[[i]] & metric=="pH"))[c("Var", "Pep1")], main=paste(Protein.names.corr[[i]], " Abundance ~ ", "\npH Variance", sep=""), ylab="Peptide 1 Abundance", xlab="Mean pH")
    dev.off()
}
...
for (i in 1:length(Protein.names.corr)) {
  ...
  dev.off()
  png(paste("results/Correlation-plots/", Protein.names.corr[[i]], "-DO Variance-Corrplot.png", sep=""), width=700, height=500)
  plot(subset(Master.SRM, (Protein==Protein.names.corr[[i]] & metric=="DO"))[c("Var", "Pep1")], main=paste(Protein.names.corr[[i]], " Abundance ~ ", "\nDO Variance", sep=""), ylab="Peptide 1 Abundance", xlab="Mean DO")
  dev.off()
}
...
for (i in 1:length(Protein.names.corr)) {
  ...
  dev.off()
  png(paste("results/Correlation-plots/", Protein.names.corr[[i]], "-Temperature Variance-Corrplot.png", sep=""), width=700, height=500)
  plot(subset(Master.SRM, (Protein==Protein.names.corr[[i]] & metric=="Temperature"))[c("Var", "Pep1")], main=paste(Protein.names.corr[[i]], " Abundance ~ ", "\nTemperature Variance", sep=""), ylab="Peptide 1 Abundance", xlab="Mean Temperature")
  dev.off()
}
...
for (i in 1:length(Protein.names.corr)) {
  ...
  dev.off()
  png(paste("results/Correlation-plots/", Protein.names.corr[[i]], "-Salinity Variance-Corrplot.png", sep=""), width=700, height=500)
  plot(subset(Master.SRM, (Protein==Protein.names.corr[[i]] & metric=="Salinity"))[c("Var", "Pep1")], main=paste(Protein.names.corr[[i]], " Abundance ~ ", "\nSalinity Variance", sep=""), ylab="Peptide 1 Abundance", xlab="Mean Salinity")
  dev.off()
}
